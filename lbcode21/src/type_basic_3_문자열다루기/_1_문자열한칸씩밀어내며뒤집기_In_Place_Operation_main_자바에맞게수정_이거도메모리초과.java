...
public class _1_문자열한칸씩밀어내며뒤집기_In_Place_Operation_main_자바에맞게수정_이거도메모리초과 {
...
//	    }
	    ...
	    tmp = input_str.substring(1, str_size) + front;
	    input_str = tmp;
...
//	    }
	    ...
	    tmp = back + input_str.substring(0, str_size - 1);
	    input_str = tmp;
