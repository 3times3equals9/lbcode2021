...
public class _6_벽이없는충돌실험_2nd_1초간격으로_움직임직접시뮬_and_충돌을2차원배열로확인_main {
	...
	static ArrayList<Marble> next_marbles;
	static int[][] next_marble_index;
	...
	static boolean OutOfActiveCoordinate(Marble marble) {
	    int x, y;
	...
	static void Simulate() {
	    ...
	    for(int i = 0; i < (int) next_marbles.size(); i++) {
	        ...
	        x = next_marbles.get(i).row;
		    y = next_marbles.get(i).col;
	...
	public static void main(String[] args) {
	    ...
	    next_marble_index = new int[COORD_SIZE + 1][COORD_SIZE + 1];
